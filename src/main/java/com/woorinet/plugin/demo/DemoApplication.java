...
//		System.out.println(odu_mpls_ifRepository.findByTid("EMS_1000_C"));
	...
	String convertTL1() {
		try {
			...
			SDNManager manager = new SDNManager(sdnNodeRepository, sdnConnectorRepository, sdnLinkRepository,serviceRepository, tunnelRepository, pathRepository, sdnConstraintRepository, sdnAccessIfRepository, tl1Nodes, tl1SystemInfos, tl1OduNodeConnectors, tl1OpticPowers, oduses, tl1OduMplsIfs, tl1Services, Tl1AccessIfs, tl1ServiceExts, tl1MplsIfs, inventories);
