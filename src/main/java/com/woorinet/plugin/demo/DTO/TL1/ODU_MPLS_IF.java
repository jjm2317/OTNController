...
public class ODU_MPLS_IF {
    ...
    public ODU_MPLS_IF(String[] fields) {
        ...
        this.NAME = fields[7];
        this.SRC_SUBNET = fields[8];
        this.SRC_TID_ID = fields[9];
        this.SRC_TID = fields[10];
        this.SRC_PORT = fields[11];
        this.DST_SUBNET = fields[12];
        this.DST_TID_ID = fields[13];
        this.DST_TID = fields[14];
        this.DST_PORT = fields[15];
        this.OPERATION_STATUS = fields[16];
        this.CONFIGURATION_ACTION = fields[17];
        this.CONFIGURATION_RESULT = fields[18];
        this.CIR = fields[19];
        this.PIR = fields[20];
        this.DEP_ENABLER = fields[21];
        this.DEP_STATUS = fields[22];
        this.CONSTRAINT_ID = fields[23];
        this.CONSTRAINT_NAME = fields[24];
        this.CONSTRAINT_VALUE = fields[25];
        this.CONSTRAINT_OPERATOR = fields[26];
        this.PORT_CONSTRAINT_TYPE = fields[27];
        this.MAXIMUM_BANDWIDTH = fields[28];
        this.AVAILABLE_BANDWIDTH = fields[29];
        this.LINK_TYPE = fields[30];
        this.IS_VENDOR = fields[31];
        this.REMOTE_NODEID = fields[32];
        this.REMOTE_NODE_CONNECTOR = fields[33];
        this.REMOTE_TOPOLOGYID = fields[34];
        this.REMOTE_MPLSIF = fields[35];
        this.PEER_MAC_ADDRESS = fields[36];
        this.MPLSIF_TYPE = fields[37];
    }
