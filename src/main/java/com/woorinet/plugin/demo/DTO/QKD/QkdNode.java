...
public class QkdNode {
    ...
    public QkdNode(String ID, String UID, String NAME, String ENABLED, String DESCRIPTION, String GROUP_ID, String QNC_WEB_API_URL, String QNC_WEB_APIAUTH, String CERT, String KEMS_CERT, String NETWORK, String CONSUMERS, String PROVIDERS, String LOC_X, String LOC_Y) {
        this.ID = ID;
        this.UID = UID;
        this.NAME = NAME;
