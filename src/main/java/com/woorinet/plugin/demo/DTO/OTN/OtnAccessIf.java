...
public class OtnAccessIf {
    ...
    public OtnAccessIf(int ems_id, String accessif_id, String accessif_name, String ne_id, String connector_id, String accessif_type, String accessif_status, String service_ref, String node_connector_ref) {
        this.ems_id = ems_id;
